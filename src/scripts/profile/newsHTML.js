const newsHTML = (newsObject) => {
    return `
        <article id="newsItem--${newsObject.id}" class="newsItem profileCard friendItem user--${newsObject.user.id}">
            ...
            <a href="${newsObject.newsURL}" target="_blank" id="newsLink--${newsObject.id}">Read Article</a>
